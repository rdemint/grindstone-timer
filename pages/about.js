...
export default function About() {
    return (
                ...
                <div class="prose">
                    <Image src="/crown_jewel20_2mb.jpg" height={432} width={768} alt="A man rock climbing a large boulder." placeholder="blur" blurDataURL="/crown_jewel20_small_blur2.jpg"/>
